<%@ Page Language="VB" AutoEventWireup="false" CodeFile="services_listbm.aspx.vb" Inherits="services_listbm" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <table style="width: 100%;">
            <tr>
                <th>Dashboard for ST.Med Services job. by AM: 
                    <asp:Label ID="lb_am" runat="server" Text="Label"></asp:Label>
                </th>
            </tr>
            <tr>
                <td>
                    <asp:GridView ID="gv_am" runat="server" CssClass="mydatagrid" PagerStyle-CssClass="pager" RowStyle-CssClass="rows" AllowPaging="True" HorizontalAlign="Center" Width="100%" PageSize="2000" >
            ...
            <tr>
                <td>
                    ...
                    <asp:GridView ID="gv_sale" runat="server" CssClass="mydatagrid" PagerStyle-CssClass="pager" RowStyle-CssClass="rows" AllowPaging="True" HorizontalAlign="Center" Width="100%" AutoGenerateColumns="False" PageSize="2000" >
                        <Columns>
                            <asp:BoundField DataField="BM" HeaderText="BM" />
            ...
            <tr>
                <th>รายละเอียดงาน <asp:Label ID="lb_sale" runat="server"></asp:Label>
                </th>
            </tr>
            <tr>
                <td>
                    <asp:GridView ID="gv_detail" runat="server" CssClass="mydatagrid" PagerStyle-CssClass="pager" RowStyle-CssClass="rows" AllowPaging="True" HorizontalAlign="Center" Width="100%" PageSize="2000" AllowSorting="True" >
                        <PagerStyle CssClass="pager" />
                        <RowStyle CssClass="rows" />
                    </asp:GridView>
                </td>
