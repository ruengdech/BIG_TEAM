<%@ Page Language="VB" AutoEventWireup="false" CodeFile="index_bm.aspx.vb" Inherits="sys01_dashboard_index_am" %>
...
<body>
    <div data-role="page" data-theme="a">
		<div data-role="header" data-position="inline">
			...
			<h1>Saintmed: ระบบงานติดตั้ง (Dashboard BM)  </h1>
		</div>
    ...
    <form id="form1" runat="server">
        ...
        <table style="width: 100%;">
            <tr>
                <td class="auto-style1">Brand Manager:&nbsp;  <asp:DropDownList ID="ddl_year" runat="server" AutoPostBack="True" data-native-menu="false" DataSourceID="DATASOURCE_BM_NAME" DataTextField="req_bmname" DataValueField="req_bmid">
                    </asp:DropDownList>
                    <asp:SqlDataSource ID="DATASOURCE_BM_NAME" runat="server" ConnectionString="<%$ ConnectionStrings:RUENGDECH_STMEDConnectionString %>" SelectCommand="SELECT req_bmid, req_bmname FROM SYS01_TS_REQUEST GROUP BY req_bmid, req_bmname ORDER BY req_bmname"></asp:SqlDataSource>
                </td>
            </tr>
            <tr>
...
WHERE req_status &lt;&gt; 'INACTIVE' and year(req_installdate) = @Pyear  and req_bmid = @BM_ID 
group by req_status
">
                        <SelectParameters>
