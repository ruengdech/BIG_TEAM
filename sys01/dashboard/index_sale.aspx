<%@ Page Language="VB" AutoEventWireup="false" CodeFile="index_sale.aspx.vb" Inherits="sys01_dashboard_index_am" %>
...
<body>
    <div data-role="page" data-theme="a">
		<div data-role="header" data-position="inline">
			...
			<h1>Saintmed: ระบบงานติดตั้ง (Dashboard SALE)  </h1>
		</div>
    ...
    <form id="form1" runat="server">
        ...
        <table style="width: 100%;">
            <tr>
                <td class="auto-style1">SALE:&nbsp;  <asp:DropDownList ID="ddl_year" runat="server" AutoPostBack="True" data-native-menu="false" DataSourceID="DATASOURCE_BM_NAME" DataTextField="staff_name" DataValueField="staff_id">
                    </asp:DropDownList>
                    <asp:SqlDataSource ID="DATASOURCE_BM_NAME" runat="server" ConnectionString="<%$ ConnectionStrings:RUENGDECH_STMEDConnectionString %>" SelectCommand="SELECT staff_id, staff_name FROM SYS01_TS_REQUEST GROUP BY staff_id, staff_name ORDER BY staff_name"></asp:SqlDataSource>
                </td>
            </tr>
            <tr>
...
WHERE req_status &lt;&gt; 'INACTIVE' and year(req_installdate) = @Pyear  and staff_id = @BM_ID 
group by req_status
">
                        <SelectParameters>
