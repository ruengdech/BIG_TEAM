...
<br />
        ...
        <asp:SqlDataSource ID="NewData2" runat="server" ConnectionString="<%$ ConnectionStrings:RUENGDECH_STMEDConnectionString %>" SelectCommand="SELECT COUNT(req_status) AS NEW FROM SYS01_TS_REQUEST WHERE (req_status LIKE 'new%') and year(req_installdate) = @Pyear">
            <SelectParameters>
...
<br />
                    ...
                    <asp:SqlDataSource ID="NewData" runat="server" ConnectionString="<%$ ConnectionStrings:RUENGDECH_STMEDConnectionString %>" SelectCommand="SELECT COUNT(req_status) AS START FROM SYS01_TS_REQUEST WHERE (req_status LIKE 'start%') and year(req_installdate) = @Pyear">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="ddl_year" DefaultValue="2021" Name="Pyear" PropertyName="SelectedValue" />
                        </SelectParameters>
                    </asp:SqlDataSource>
...
<br />
                    ...
                    <asp:SqlDataSource ID="PlanData" runat="server" ConnectionString="<%$ ConnectionStrings:RUENGDECH_STMEDConnectionString %>" SelectCommand="SELECT COUNT(req_status) AS START FROM SYS01_TS_REQUEST WHERE (req_status LIKE 'plan%') and year(req_installdate) = @Pyear">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="ddl_year" DefaultValue="2021" Name="Pyear" PropertyName="SelectedValue" />
                        </SelectParameters>
                          </asp:SqlDataSource>
...
<br />
                    ...
                    <asp:SqlDataSource ID="AssignData" runat="server" ConnectionString="<%$ ConnectionStrings:RUENGDECH_STMEDConnectionString %>" SelectCommand="SELECT COUNT(req_status) AS ASSIGNED FROM SYS01_TS_REQUEST WHERE (req_status LIKE 'assigned%') and year(req_installdate) = @Pyear">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="ddl_year" DefaultValue="2021" Name="Pyear" PropertyName="SelectedValue" />
                        </SelectParameters>
                          </asp:SqlDataSource>
...
<br />
                    ...
                    <asp:SqlDataSource ID="FinishData" runat="server" ConnectionString="<%$ ConnectionStrings:RUENGDECH_STMEDConnectionString %>" SelectCommand="SELECT COUNT(req_status) AS FINISH FROM SYS01_TS_REQUEST WHERE (req_status LIKE 'finish%') and year(req_installdate) = @Pyear">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="ddl_year" DefaultValue="2021" Name="Pyear" PropertyName="SelectedValue" />
                        </SelectParameters>
                          </asp:SqlDataSource>
      ...
      <asp:DataList ID="DataList6" runat="server" DataSourceID="UrgentworkData">
          ...
          <ItemTemplate>
              ด่วนที่สุด<br /> &nbsp;<asp:Label ID="จำนวนงานLabel" runat="server" Text='<%# Eval("จำนวนงาน") %>' />
              <br />
              <br />
          </ItemTemplate>
      </asp:DataList>
       <asp:SqlDataSource ID="UrgentworkData" runat="server" ConnectionString="<%$ ConnectionStrings:RUENGDECH_STMEDConnectionString %>" SelectCommand="SELECT CASE WHEN DATEDIFF(day , req_date , req_installdate) = 3 THEN '01 งานด่วนมาก' ELSE CASE WHEN DATEDIFF(day , req_date , req_installdate) = 6 THEN '02 งานด่วน' ELSE '03 งานปรกติ' END END AS ประเภทของงาน, COUNT(*) AS จำนวนงาน FROM SYS01_TS_REQUEST WHERE (DATEDIFF(day, req_date, req_installdate) = 3) and year(req_installdate) = @Pyear GROUP BY DATEDIFF(day, req_date, req_installdate)">
           <SelectParameters>
               <asp:ControlParameter ControlID="ddl_year" DefaultValue="2021" Name="Pyear" PropertyName="SelectedValue" />
           </SelectParameters>
                    </asp:SqlDataSource>
        ...
        <asp:DataList ID="DataList7" runat="server" DataSourceID="StandardWork">
            ...
            <ItemTemplate>
                งานปกติ<br />
                <asp:Label ID="จำนวนงานLabel" runat="server" Text='<%# Eval("งานปกติ") %>' />
                <br />
                <br />
            </ItemTemplate>
        </asp:DataList>
        <asp:SqlDataSource ID="StandardWork" runat="server" ConnectionString="<%$ ConnectionStrings:RUENGDECH_STMEDConnectionString %>" SelectCommand="SELECT COUNT(req_date) AS งานปกติ 
FROM SYS01_TS_REQUEST 
WHERE (DATEDIFF(day, req_date, req_installdate) &gt; 6) AND (YEAR(req_installdate) = @Pyear)">
            <SelectParameters>
                <asp:ControlParameter ControlID="ddl_year" DefaultValue="2021" Name="Pyear" PropertyName="SelectedValue" />
            </SelectParameters>
                    </asp:SqlDataSource>
     ...
     <asp:DataList ID="DataList8" runat="server" DataSourceID="EndTask" Font-Bold="True">
           ...
           <asp:SqlDataSource ID="EndTask" runat="server" ConnectionString="<%$ ConnectionStrings:RUENGDECH_STMEDConnectionString %>" SelectCommand="SELECT COUNT(req_isfinish) AS isfinish FROM SYS01_TS_REQUEST WHERE (req_status LIKE 'finish%') AND (YEAR(req_installdate) = @Pyear) AND (req_isfinish &lt;&gt; 'TRUE')">
               <SelectParameters>
                   <asp:ControlParameter ControlID="ddl_year" DefaultValue="2021" Name="Pyear" PropertyName="SelectedValue" />
               </SelectParameters>
          </asp:SqlDataSource>
   ...
   <asp:DataList ID="DataList9" runat="server" DataSourceID="EndTaskElse" Font-Bold="True">
            ...
            <ItemTemplate>
              ...
              <asp:SqlDataSource ID="EndTaskElse" runat="server" ConnectionString="<%$ ConnectionStrings:RUENGDECH_STMEDConnectionString %>" SelectCommand="SELECT COUNT(req_isfinish) AS isfinish FROM SYS01_TS_REQUEST WHERE (req_isfinish = 'TRUE') AND (YEAR(req_installdate) = @Pyear)">
                  <SelectParameters>
                      <asp:ControlParameter ControlID="ddl_year" DefaultValue="2021" Name="Pyear" PropertyName="SelectedValue" />
                  </SelectParameters>
              </asp:SqlDataSource>
        ...
        <center>
                    ...
                    <asp:Chart ID="Chart2" runat="server" DataSourceID="AmData" Height="520px" Width="650px" BorderlineWidth="2" DataMember="DefaultView" TabIndex="12" ViewStateContent="All" ViewStateMode="Enabled" IsMapAreaAttributesEncoded="True">
                        <Series>
                            <asp:Series ChartType="Bar" Name="Series1" XValueMember="req_amname" YValueMembers="CountAM" ChartArea="ChartArea1" IsValueShownAsLabel="True" IsXValueIndexed="True" MapAreaAttributes="#VALX" LabelUrl="~/sys01/dashboard/data_am.aspx?req_am_name=#VALX">
                            </asp:Series>
                        </Series>
                        <MapAreas>
                    ...
                    <asp:Chart ID="Chart3" runat="server" DataSourceID="BmData" Height="520px" Width="650px">
                        <Series>
                            <asp:Series ChartArea="ChartArea1" ChartType="Bar" IsValueShownAsLabel="True" IsXValueIndexed="True" Name="Series1" XValueMember="req_bmname" YValueMembers="Countbm" LabelUrl="~/sys01/dashboard/data_bm.aspx?req_bm_id=#VALX" MapAreaAttributes="#VALX">
                            </asp:Series>
                        </Series>
                        <ChartAreas>
                            <asp:ChartArea Name="ChartArea1">
                    ...
                    <asp:SqlDataSource ID="BmData" runat="server" ConnectionString="<%$ ConnectionStrings:RUENGDECH_STMEDConnectionString %>" SelectCommand="SELECT req_bmid, COUNT(req_bmid) AS Countbm, req_bmname FROM SYS01_TS_REQUEST WHERE (req_group = 00) AND (req_status &lt;&gt; 'INACTIVE') and year(req_installdate) = @Pyear GROUP BY req_bmid, req_bmname ORDER BY Countbm DESC">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="ddl_year" DefaultValue="2021" Name="Pyear" PropertyName="SelectedValue" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                    <asp:Chart ID="Chart4" runat="server" DataSourceID="HeadMaintainData" Height="1126px" Width="1386px">
                        <Series>
                            <asp:Series ChartType="Bar" IsValueShownAsLabel="True" Name="Series1" XValueMember="S_NAME" YValueMembers="Engineer" LabelUrl="~/sys01/dashboard/data_engineer.aspx?req_engineer_id=#VALX" MapAreaAttributes="#VALX">
                            </asp:Series>
                        </Series>
                        <ChartAreas>
                            <asp:ChartArea Name="ChartArea1">
                    ...
                    <asp:SqlDataSource ID="HeadMaintainData" runat="server" ConnectionString="<%$ ConnectionStrings:RUENGDECH_STMEDConnectionString %>" SelectCommand="SELECT COUNT(S_NAME) AS Engineer, S_ID, S_NAME FROM SYS01_VIEW_ENGINEER_JOB WHERE (req_status &lt;&gt; 'INACTIVE') AND (YEAR(req_installdate) = @Pyear) GROUP BY S_ID, S_NAME ORDER BY Engineer DESC">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="ddl_year" DefaultValue="2021" Name="Pyear" PropertyName="SelectedValue" />
                        </SelectParameters>
                    </asp:SqlDataSource>
