...
                    <h2>ข้อมูลขอรับบริการทั้งหมด</h2>
                    ...
                    <div style="overflow-x:auto;">
                        <table id="tb_history"  class="table_job_list">
                            <thead>
                                <tr class="tr_main"><th style="width:50px">เลขที่</th>
                                    <th>วันที่แจ้ง / แจ้งโดย</th>
                                    <th>วันที่ต้องการงาน</th>
                                    <th>หัวข้อที่แจ้ง</th>
                                    <th>สถานที่ติดตั้ง</th>
                                    <th>AM / BM</th>
                                    <th>ทีมช่าง</th>
                                    <th>สถานะ (ปัจจุบัน)</th>
                                    <th>อัพเดตสถานะ</th>
                                </tr>
                                <td><a>เลขที่</a></td>
                                <td>5555</td>
...
                                    <option value="อื่นๆ">อื่นๆ</option>
                        ...
                        <div class="ui-grid-a ui-responsive ui-margin" id="div_plan">
