...
<div data-role="page" id="page_assignlist" data-theme="a">
...
                        <h2>ข้อมูล การขอใช้บริการที่ Assign ช่างแล้ว</h2>
                    ...
                    <div class="ui-body ui-body-a">
                        ...
                        <div id="div_list_assigned" style="overflow-x:auto;">
                            <table id="tb_list_assigned"  class="table_job_list" >
...
<div data-role="page" id="page_assigndetail" data-theme="a" >
...
<div data-role="content" data-theme="a">
    ...
    <div class="ui-grid-b ui-responsive">
        ...
        <div class="ui-block-a">
            ...
            <input type="text" name="p_assign_txt_staffId" id="p_assign_txt_staffId" readonly="readonly" />
            <input type="hidden" id="p_assign_uid" />
        </div>
        <div class="ui-block-b">
            <label for="p_assign_txt_name">ชื่อ:</label>
            <input type="text" name="p_assign_txt_name" id="p_assign_txt_name" readonly="readonly" />
        </div>
        <div class="ui-block-c">
            <label for="p_assign_txt_lname">นามสกุล:</label>
            <input type="text" name="p_assign_txt_lname" id="p_assign_txt_lname" readonly="readonly" />
        </div>
    </div><!-- <div class="ui-grid-b ui-responsive"> -->
    <div class="ui-grid-a ui-responsive">
        <div class="ui-block-a">
            <label for="p_assign_submitDate">วันที่บันทึก :</label>
            <input type="text" name="p_assign_submitDate" id="p_assign_submitDate" readonly="readonly" />
        </div>
        <div class="ui-block-b">
            <label for="p_assign_computedate">Compute: </label>
            <input type="email" name="p_assign_computedate" id="p_assign_computedate" readonly="readonly" />
        </div>
        <div class="ui-block-a">
            <label for="p_assign_txt_mobile">Mobile :</label>
            <input type="text" name="p_assign_txt_mobile" id="p_assign_txt_mobile" readonly="readonly" />
        </div>
        <div class="ui-block-b">
            <label for="p_assign_txt_email">Email: </label>
            <input type="email" name="p_assign_txt_email" id="p_assign_txt_email" readonly="readonly" />
        </div>
        ...
        <div class="ui-block-a">
            ...
            <input type="text" name="p_assign_txt_location" id="p_assign_txt_location"  />
        </div>
        <div class="ui-block-b">
        ...
        <div class="ui-block-a">
            <label for="p_assign_txt_contact">ชื่อผู้ติดต่อ :</label>
        ...
        <div class="ui-block-a">
            <label for="p_assign_sel_staff">จำนวนช่าง :</label>
            <select name="p_assign_sel_staff" id="p_assign_sel_staff" data-native-menu="false">
        ...
        <div class="ui-block-b">
            <label for="p_assign_txt_assign_date">วันเวลาที่ Assign งาน:</label>
            <input type="text" name="p_assign_txt_assign_date" id="p_assign_txt_assign_date" value="" />
        </div>
    </div><!-- <div class="ui-grid-a ui-responsive"> -->
    <div class="ui-grid-solo ui-responsive">
        <div class="ui-block-a">
            <label for="p_assign_sel_staff1">ช่างที่มอบหมาย :</label>
            <select name="p_assign_sel_staff1" id="p_assign_sel_staff1" data-native-menu="false">
                <option value="0" selected="selected">เลือกช่างคนที่ 1</option>
            </select>
        </div>
        <div class="ui-block-a">
            <label for="p_assign_sel_staff2">ช่างที่มอบหมาย :</label>
            <select name="p_assign_sel_staff2" id="p_assign_sel_staff2" data-native-menu="false">
                <option value="0" selected="selected">เลือกช่างคนที่ 2</option>
            </select>
        </div>
        <div class="ui-block-a">
            <label for="p_assign_sel_staff3">ช่างที่มอบหมาย :</label>
            <select name="p_assign_sel_staff1" id="p_assign_sel_staff3" data-native-menu="false">
                <option value="0" selected="selected">เลือกช่างคนที่ 3</option>
            </select>
        </div>
        <div class="ui-block-a">
            <label for="p_assign_sel_staff4">ช่างที่มอบหมาย :</label>
            <select name="p_assign_sel_staff1" id="p_assign_sel_staff4" data-native-menu="false">
                <option value="0" selected="selected">เลือกช่างคนที่ 4</option>
            </select>
        </div>
        <div class="ui-block-a">
            <label for="p_assign_txt_assignid">พนักงานที่มอบหมายงาน</label>
            <input type="text" name="p_assign_txt_assignid" id="p_assign_txt_assignid"  />
            <input type="text" name="p_assign_txt_assignname" id="p_assign_txt_assignname" readonly="readonly" />
        </div>
        <div class="ui-block-a">
            <input type="button" id="p_assign_bt_save" value="บันทึกข้อมูล" />
        </div>
    </div><!-- <div class="ui-grid-solo ui-responsive"> -->
    <div class="ui-grid-a ui-responsive" id="p_assign_div_engineer">
        <h2>ข้อมูลการปฏิบัติงาน</h2>
        <div class="ui-block-a">
            <label for="p_assign_txt_date_start">วันเวลาที่เริ่มงาน:</label>
            <input type="date" name="p_assign_txt_date_start" id="p_assign_txt_date_start" value="" />
            <input type="time" name="p_assign_txt_time_start" id="p_assign_txt_time_start" />
        </div>
        <div class="ui-block-b">
            <label for="p_assign_txt_date_end">วันเวลาที่ดำเนินการเสร็จ:</label>
            <input type="date" name="p_assign_txt_date_end" id="p_assign_txt_date_end" value="" />
            <input type="time" name="p_assign_txt_time_end" id="p_assign_txt_time_end" />
        </div>
        <div class="ui-block-a">
...
<div data-role="page" id="page_engineerlist" data-theme="a">
    
		<div data-role="header" data-position="inline">
			<h2>ระบบ บริการติดตั้ง/ซ่อมบำรุงเครื่องมือแพทย์ (SUPERVISOR)</h2>
		</div>
		<div data-role="content" data-theme="a">
                <div id="engineer_list" class="ui-body-d ui-content ui-corner-all">
                    <div class="ui-bar ui-bar-a">
                        <h2>ข้อมูล การขอใช้บริการที่รอ Assign งาน</h2>                        
                    </div>
                    <div class="ui-body ui-body-a">
                        <div id="div_list_waitstart" style="overflow-x:auto;">
                            <table id="tb_list_waitstart" class="table_job_list" >
                                <tr><th style="width:50px">เลขที่</th><th>วันที่แจ้ง / แจ้งโดย</th><th>หัวข้อที่แจ้ง</th><th>สถานที่ติดตั้ง</th><th>AM / BM</th><th>สถานะ</th></tr>
                            </table>
                        </div>                    
                    </div><%--<div class="ui-body ui-body-a">--%>
...
                        <h2>ข้อมูล การขอใช้บริการที่ Assign ช่างแล้ว</h2>
                    ...
                    <div class="ui-body ui-body-a">
                        <input id="txt_search_engineer" style="width:94%; padding: 12px 12px 12px 12px; font-size:14pt" type="text" placeholder="Search.." /><br />
                        <div id="div_list_engineer" style="overflow-x:auto;">
                            <table id="tb_list_engineer"  class="table_job_list" >
                                <tr><th style="width:50px">เลขที่</th><th>วันที่แจ้ง / แจ้งโดย</th><th>หัวข้อที่แจ้ง</th><th>สถานที่ติดตั้ง</th><th>AM / BM</th><th>ช่างที่ได้รับ Assign</th><th>สถานะ</th></tr>
                            </table>
                        </div>                        
                    </div><!--<%--<div class="ui-body ui-body-a">--%>-->                    
