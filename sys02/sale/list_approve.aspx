...
<%
    Session("URL") = "../../sys02/sale/list_approve.aspx"
    ...
    Try
        clsa.strSql = "SELECT TOP 50 ID, project_code1, pro_value, funnel_id " &
             " FROM projects " &
             " WHERE (projects.funnel_id <> '') " &
             " Order by ID DESC "
        If clsa.func_SetDataSet(clsa.strSql, "PROJECT_DATA") Then
            If clsa.ds.Tables("PROJECT_DATA").Rows.Count > 0 Then
                For i As Integer = 0 To clsa.ds.Tables("PROJECT_DATA").Rows.Count - 1
                    With clsa.ds.Tables("PROJECT_DATA").Rows(i)
                        cls.strSql = "UPDATE SYS02_TS_SALE SET " &
...
<% 
    ...
    '40 SALE_REQUEST_ID
    '41 SALE_PROJECT_ID
    '42 FREE FOR SEARCH APPROVE STATUS
    '43 SALE_REQUEST_STATUS
	...
	<div data-role="page" id="page_main">
		...
		<div data-role="content" class="ui-content" data-theme="c">
            <div class="ui-bar ui-bar-a center">
                <h3>รายการขาย รอการอนุมัติโครงการ</h3>
            </div>
            ...
            <div class="container">   
                <div class="row">
                    <div class="panel panel-primary filterable">
                        ...
                        <p>Sum Total(Inc Vat) : <span id="sum_amout"></span></p>
...
<%--                                <th><input id="s_prob" type="text" class="form-control" placeholder="ความน่าจะเป็น"onkeyup = "check_filter(event)"  /></th>--%>
                                ...
                                <th><input id="s_approve_status" type="text" class="form-control" placeholder="สถานะโครงการ" onkeyup = "check_filter(event)"  /></th>
		...
		<div data-role="footer" data-position="fixed" style="background-color:#f1f1f3!important;vertical-align:middle;color:darkslategrey;border:none;">
			<div class="ui-grid-c center">
				...
				<div class="ui-block-c" style="min-height:50px;margin:auto;"><a href="../am/list_approve.aspx" target="_blank" rel="external"><img src="../RESOURCE/themes/images/set02/022-copy.png" style="margin-top: 5px!important; width:35px; "/></a></div>
				...
				<div class="ui-block-a" style="font-size:0.7em;" >รายการรออนุมัติ</div>
				<div class="ui-block-b" style="font-size:0.7em;" >รายละเอียด</div>
				<div class="ui-block-c" style="font-size:0.7em;" >AM อนุมัติ</div>
...
<script src="../JS/sys02.list_approve.js"></script>
    </html>
