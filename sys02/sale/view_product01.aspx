...
<% 
    ...
    If Session("USER_CATEGORY").ToString().IndexOf("DIRECTOR") > -1 Then
        ...
        cls.strSql = "SELECT SALE_ORDER_YEAR, SALE_ORDER_MONTH, BRAND_NAME, STAFF_NAME, REVENUE, ORDERPROB_ID, ORDERPROB_NAME FROM SYS02_VIEW_CUSTOMER ORDER BY SALE_ORDER_YEAR, SALE_ORDER_MONTH, ORDERPROB_ID"
        cls.func_SetDataSet(cls.strSql, "JOB_DATA")

        cls.strSql = "SELECT SALE_HOSPITAL, STAFF_NAME, 0 AS [0], 0 AS [1], 0 AS [2], 0 AS [3], 0 AS [4], 0 AS [5], 0 AS [6], 0 AS [7], 0 AS [8], 0 AS [9], 0 AS [10], 0 AS [11], 0 AS [12] FROM SYS02_VIEW_CUSTOMER GROUP BY SALE_HOSPITAL, STAFF_NAME ORDER BY SALE_HOSPITAL, STAFF_NAME"
        cls.strSql = "SELECT BRAND_NAME, STAFF_NAME, 0 AS [0], 0 AS [1], 0 AS [2], 0 AS [3], 0 AS [4], 0 AS [5], 0 AS [6], 0 AS [7], 0 AS [8], 0 AS [9], 0 AS [10], 0 AS [11], 0 AS [12] FROM SYS02_VIEW_CUSTOMER GROUP BY BRAND_NAME, STAFF_NAME ORDER BY BRAND_NAME, STAFF_NAME"
        cls.func_SetDataSet(cls.strSql, "STAFF_DATA") ' HOSPITAL_DATA
    ...
    Else
        ...
        cls.strSql = "SELECT SALE_ORDER_YEAR, SALE_ORDER_MONTH, BRAND_NAME, STAFF_NAME, REVENUE, ORDERPROB_ID, ORDERPROB_NAME FROM SYS02_VIEW_CUSTOMER  WHERE (SALE_STAFF_AM_ID = '" & USER_STAFF_ID & "') OR  (SALE_STAFF_ID = '" & USER_STAFF_ID & "')  ORDER BY SALE_ORDER_YEAR, SALE_ORDER_MONTH, ORDERPROB_ID"
        cls.func_SetDataSet(cls.strSql, "JOB_DATA")

        cls.strSql = "SELECT SALE_STAFF_ID, STAFF_NAME, 0 AS [0], 0 AS [1], 0 AS [2], 0 AS [3], 0 AS [4], 0 AS [5], 0 AS [6], 0 AS [7], 0 AS [8], 0 AS [9], 0 AS [10], 0 AS [11], 0 AS [12] FROM SYS02_VIEW_CUSTOMER WHERE (SALE_STAFF_AM_ID = '" & USER_STAFF_ID & "') OR  (SALE_STAFF_ID = '" & USER_STAFF_ID & "') GROUP BY SALE_STAFF_ID, STAFF_NAME ORDER BY STAFF_NAME"
        cls.strSql = "SELECT BRAND_NAME, STAFF_NAME, 0 AS [0], 0 AS [1], 0 AS [2], 0 AS [3], 0 AS [4], 0 AS [5], 0 AS [6], 0 AS [7], 0 AS [8], 0 AS [9], 0 AS [10], 0 AS [11], 0 AS [12] FROM SYS02_VIEW_CUSTOMER WHERE (SALE_STAFF_AM_ID = '" & USER_STAFF_ID & "') OR  (SALE_STAFF_ID = '" & USER_STAFF_ID & "') GROUP BY BRAND_NAME, STAFF_NAME ORDER BY BRAND_NAME, STAFF_NAME"
        cls.func_SetDataSet(cls.strSql, "STAFF_DATA") ' HOSPITAL_DATA
    End If
    '0   SALE_ORDER_YEAR
    '1   SALE_ORDER_MONTH
...
                    </fieldset>
                ...
                <div style="width: 100%; overflow-x:auto!important;">
                    <table>
                        <tr>
                            <td>กรองข้อมูล Brand</td>
                            <td> </td>
                            <td><input type="text" id="myInput1" onkeyup="myFunction()" placeholder="พิมพ์เพื่อค้นหา" /></td>
                            <td style="width:20px"> </td>
                            <td>กรองข้อมูล พนักงานขาย</td>
                            <td> </td>
                            <td><input type="text" id="myInput2" onkeyup="myFunction()" placeholder="พิมพ์เพื่อค้นหา" /></td>
                         </tr>
                    </table>
...
<script src="../JS/sys02.view_product01.js"></script>
    </html>
