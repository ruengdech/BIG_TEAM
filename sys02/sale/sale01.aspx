            ...
            <div class="ui-bar ui-bar-a center">
                <h3>รายการขาย
                    <%
                        ...
                        cls.func_SetDataSet(cls.strSql, "STAFF2")
                        If cls.ds.Tables("STAFF2").Rows.Count > 0 Then
                            Response.Write("สิทธิ์ทีมขาย | <a  style='color:white;' href='sale02.aspx' target='_blank' rel='external'>สิทธิ์การตลาด</a>")
                        End If
