...
<%
    Session("URL") = "../../sys02/sale/view_bm_sale.aspx"
...
<% 
    ...
    If Session("USER_CATEGORY").ToString().IndexOf("DIRECTOR") > -1 Then
        ...
        cls.strSql = "SELECT SALE_ORDER_YEAR, SALE_ORDER_MONTH, BM_NAME, STAFF_NAME, REVENUE, ORDERPROB_ID, ORDERPROB_NAME FROM SYS02_VIEW_BM_STAFF ORDER BY SALE_ORDER_YEAR, SALE_ORDER_MONTH, ORDERPROB_ID"
        ...
        cls.strSql = "SELECT BM_NAME, STAFF_NAME, 0 AS [0], 0 AS [1], 0 AS [2], 0 AS [3], 0 AS [4], 0 AS [5], 0 AS [6], 0 AS [7], 0 AS [8], 0 AS [9], 0 AS [10], 0 AS [11], 0 AS [12] FROM SYS02_VIEW_BM_STAFF GROUP BY BM_NAME, STAFF_NAME ORDER BY BM_NAME, STAFF_NAME"
    ...
    Else
        ...
        cls.strSql = "SELECT SALE_ORDER_YEAR, SALE_ORDER_MONTH, BM_NAME, STAFF_NAME, REVENUE, ORDERPROB_ID, ORDERPROB_NAME FROM SYS02_VIEW_BM_STAFF  WHERE (SALE_STAFF_AM_ID = '" & USER_STAFF_ID & "') OR  (SALE_STAFF_ID = '" & USER_STAFF_ID & "')  ORDER BY SALE_ORDER_YEAR, SALE_ORDER_MONTH, ORDERPROB_ID"
        cls.func_SetDataSet(cls.strSql, "JOB_DATA")
        ...
        cls.strSql = "SELECT BM_NAME, STAFF_NAME, 0 AS [0], 0 AS [1], 0 AS [2], 0 AS [3], 0 AS [4], 0 AS [5], 0 AS [6], 0 AS [7], 0 AS [8], 0 AS [9], 0 AS [10], 0 AS [11], 0 AS [12] FROM SYS02_VIEW_BM_STAFF WHERE (SALE_STAFF_AM_ID = '" & USER_STAFF_ID & "') OR  (SALE_STAFF_ID = '" & USER_STAFF_ID & "') GROUP BY BM_NAME, STAFF_NAME ORDER BY BM_NAME, STAFF_NAME"
        cls.func_SetDataSet(cls.strSql, "STAFF_DATA") ' HOSPITAL_DATA
    End If
    '0   SALE_ORDER_YEAR
    '1   SALE_ORDER_MONTH
...
<script src="../JS/sys02.view_bm_sale.js"></script>
    </html>
