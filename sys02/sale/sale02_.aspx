	...
	<div data-role="page" id="page_main">
                    ...
                    <div class="panel panel-primary filterable">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <button class="ui-mini btn-filter">ใช้/ยกเลิก Filter</button>
                            </h3>
                        </div>
                        <table id="tb_list"  class="table table-bordered table-striped table_list">
                            <thead>
                            <tr class="filters">
                                <th><input type="text" class="form-control" placeholder="วันที่ยื่นซอง" /></th>
                                <th><input type="text" class="form-control" placeholder="โรงพยาบาล"  /></th>
                                <th><input type="text" class="form-control" placeholder="แบรนด์"  /></th>
                                <th><input type="text" class="form-control" placeholder="สินค้า | โมเดล"  /></th>
                                <th><input type="text" class="form-control" placeholder="ราคา/หน่วย" /></th>
                                <th><input type="text" class="form-control" placeholder="จำนวน" /></th>
                                <th><input type="text" class="form-control" placeholder="ราคารวม Vat" /></th>
                                <th><input type="text" class="form-control" placeholder="สถานะ" /></th>
                                <th><input type="text" class="form-control" placeholder="คาดการณ์สินค้าเข้า" /></th>
                                <th><input type="text" class="form-control" placeholder="ปี / เดือน" /></th>
                                <th><input type="text" class="form-control" placeholder="ความน่าจะเป็น" /></th>
                                <th><input type="text" class="form-control" placeholder="ประเภทงบ" /></th>
                                <th><input type="text" class="form-control" placeholder="พนักงานขาย" /></th>
                                <th><input type="text" class="form-control" placeholder="AM" /></th>
                                <th><input type="text" class="form-control" placeholder="BM" /></th>
                                <th><input type="text" class="form-control" placeholder="หมายเหตุ" /></th>
                                <th><input type="text" class="form-control" placeholder="แก้ไขล่าสุด" /></th>
                            </tr>
                            </thead>
                            <tbody>
							        <% 
		...
		<div data-role="footer" data-position="fixed" style="background-color:#f1f1f3!important;vertical-align:middle;color:darkslategrey;border:none;">
			<div class="ui-grid-c center">
				...
				<div class="ui-block-c" style="min-height:50px;margin:auto;"><a href="view_am.aspx" rel="external"><img src="../RESOURCE/themes/images/set02/024-dashboard.png" style="margin-top: 5px!important; width:35px;" /></a></div>
				...
				<div class="ui-block-c" style="font-size:0.7em;" >Dashboard(AM)</div>
