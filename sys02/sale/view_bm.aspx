...
<script runat="server">
    ...
    Dim USER_STAFF_ID As String = "313001" ' "" '
...
<%
    Session("URL") = "../../sys02/sale/view_bm.aspx"
...
<% 
    ...
    If cls.ds.Tables("STAFF").Rows.Count > 0 Then
        With cls.ds.Tables("STAFF").Rows(0)
            ...
            'End If
            CONDITION_ = " AND (" & .Item(1).ToString & ")   "
        End With
    Else
        Response.End()
    End If
    ...
    If Session("USER_CATEGORY").ToString().IndexOf("DIRECTOR") > -1 Then
        cls.strSql = "SELECT SALE_ORDER_YEAR, SALE_ORDER_MONTH, BRAND_NAME, ORDERPROB_ID, ORDERPROB_NAME, REVENUE, SALE_STAFF_BM_ID FROM SYS02_VIEW_BM_VIEW ORDER BY SALE_ORDER_YEAR, SALE_ORDER_MONTH, BRAND_NAME, ORDERPROB_ID"
        cls.func_SetDataSet(cls.strSql, "JOB_DATA")

        cls.strSql = "SELECT '' as DUMMY, BRAND_NAME, 0 AS [0], 0 AS [1], 0 AS [2], 0 AS [3], 0 AS [4], 0 AS [5], 0 AS [6], 0 AS [7], 0 AS [8], 0 AS [9], 0 AS [10], 0 AS [11], 0 AS [12] FROM SYS02_VIEW_BM_VIEW GROUP BY BRAND_NAME ORDER BY BRAND_NAME"
    ...
    Else
        ...
        cls.strSql = "SELECT SALE_ORDER_YEAR, SALE_ORDER_MONTH, BRAND_NAME, ORDERPROB_ID, ORDERPROB_NAME, REVENUE, SALE_STAFF_BM_ID FROM SYS02_VIEW_BM_VIEW WHERE (1=1) " & CONDITION_ & " ORDER BY SALE_ORDER_YEAR, SALE_ORDER_MONTH, BRAND_NAME, ORDERPROB_ID"
        cls.func_SetDataSet(cls.strSql, "JOB_DATA")
        ...
        cls.strSql = "SELECT '' as DUMMY, BRAND_NAME, 0 AS [0], 0 AS [1], 0 AS [2], 0 AS [3], 0 AS [4], 0 AS [5], 0 AS [6], 0 AS [7], 0 AS [8], 0 AS [9], 0 AS [10], 0 AS [11], 0 AS [12] FROM SYS02_VIEW_BM_VIEW WHERE (1=1) " & CONDITION_ & " GROUP BY BRAND_NAME ORDER BY BRAND_NAME"
        cls.func_SetDataSet(cls.strSql, "STAFF_DATA")
    End If
    '0   SALE_ORDER_YEAR
    '1   SALE_ORDER_MONTH
...
<script src="../JS/sys02.view_bm.js"></script>
    </html>
