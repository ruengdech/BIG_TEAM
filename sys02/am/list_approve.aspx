...
<% 
    ...
    cls.strSql = "SELECT STAFF_ID, STAFF_TYPE FROM SYS01_MS_STAFF WHERE (STAFF_TYPE LIKE '%AREAMANAGER%') AND (STAFF_ID = '" & USER_STAFF_ID & "')"
    cls.func_SetDataSet(cls.strSql, "VALIDATE")

    If cls.ds.Tables("VALIDATE").Rows.Count = 0 Then
        Response.Redirect("../sale/list_approve.aspx")
    End If
...
<%--                                <th><input id="s_prob" type="text" class="form-control" placeholder="ความน่าจะเป็น"onkeyup = "check_filter(event)"  /></th>--%>
		...
		<%--<div data-role="footer" data-position="fixed" style="background-color:#f1f1f3!important;vertical-align:middle;color:darkslategrey;border:none;">
			<div class="ui-grid-b center">
				...
				<div class="ui-block-c" style="min-height:50px;margin:auto;"><a href="log_out.aspx" onclick="log_out()" rel="external"><img src="../RESOURCE/themes/images/set02/061-outside.png" style="margin-top: 5px!important; width:35px;" /></a></div>
                
				<div class="ui-block-a" style="font-size:0.7em;" >รายการรออนุมัติ</div>
				<div class="ui-block-b" style="font-size:0.7em;" >รายละเอียด</div>
				<div class="ui-block-c" style="font-size:0.7em;" >Logout</div>
...
<script src="../JS/sys02.list_approve_am.js"></script>
    </html>
