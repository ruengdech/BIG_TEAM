...
<%
    ...
    Session("URL") = "../../sys02/sale/view_director_bm.aspx"
...
<% 
    ...
    cls.strSql = "SELECT SALE_ORDER_YEAR, SALE_ORDER_MONTH, STAFF_NAME, ORDERPROB_ID, ORDERPROB_NAME, REVENUE, SALE_STAFF_BM_ID FROM  VIEW_DIRECTOR_BM_VIEW WHERE (1 = 1) ORDER BY SALE_ORDER_YEAR, SALE_ORDER_MONTH, ORDERPROB_ID"
    ...
    cls.strSql = "SELECT SALE_STAFF_BM_ID, STAFF_NAME, 0 AS [1], 0 AS [2], 0 AS [3], 0 AS [4], 0 AS [5], 0 AS [6], 0 AS [7], 0 AS [8], 0 AS [9], 0 AS [10], 0 AS [11], 0 AS [12] FROM VIEW_DIRECTOR_BM_VIEW WHERE (1 = 1) GROUP BY SALE_STAFF_BM_ID, STAFF_NAME ORDER BY STAFF_NAME"
                ...
                <table id="tb_menu"  class="table table-bordered table-striped table_list">
                    <thead>
                        <tr>
                                ...
                                <td style="text-align:center; width:14%"><a href="view_director_am_ad.aspx"  rel="external">AM (A,D)</a></td>
                                <td style="text-align:center; width:14%">BM (A,D)</td>
...
<script src="../JS/sys02.view_director_bm.js"></script>
    </html>
