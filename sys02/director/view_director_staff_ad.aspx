...
<%
    ...
    Session("URL") = "../../sys02/director/view_director_staff.aspx"
...
<% 
    ...
    cls.strSql = "SELECT SALE_STAFF_ID, STAFF_NAME, 0 AS [1], 0 AS [2], 0 AS [3], 0 AS [4], 0 AS [5], 0 AS [6], 0 AS [7], 0 AS [8], 0 AS [9], 0 AS [10], 0 AS [11], 0 AS [12] FROM SYS02_VIEW_AM_VIEW WHERE (1 = 1) GROUP BY SALE_STAFF_ID, STAFF_NAME ORDER BY STAFF_NAME"
                ...
                <table id="tb_menu"  class="table table-bordered table-striped table_list">
                    <thead>
                        <tr>
                                ...
                                <td style="text-align:center; width:14%">STAFF (A,D)</td>
...
<script src="../JS/sys02.view_director_staff.js"></script>
    </html>
