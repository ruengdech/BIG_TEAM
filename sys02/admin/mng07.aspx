...
<% 
    ...
    cls.strSql = "SELECT BRAND_ID, BRAND_NAME, BRAND_STATUS FROM SYS02_MS_BRAND ORDER BY BRAND_NAME"
	...
	<div data-role="page" id="page_main">
			...
			<div class="ui-grid-a ui-responsive">
				<div class="ui-block-a" style="width:65%;" >
                    ...
                    <table id="tb_list" class="table_list">
						<thead>
							<tr class="tr_main"><th style="width:50px">รหัส</th><th>ชื่อแบรนด์</th><th> State </th><th> แก้ไข </th></tr>
                        </thead>
						<tbody>
							<% 
                                If cls.ds.Tables("JOB_DATA").Rows.Count > 0 Then
                                    For i As Integer = 0 To cls.ds.Tables("JOB_DATA").Rows.Count - 1
                                        With cls.ds.Tables("JOB_DATA").Rows(i)
                                            ...
                                            Response.Write("<td>")
                                            Response.Write(.Item("BRAND_ID").ToString())
                                            Response.Write("</td>")
                                            ...
                                            Response.Write("<td>")
                                            Response.Write(.Item("BRAND_STATUS").ToString())
                                            Response.Write("</td>")

                                            Response.Write("<td class='center'>")
                                            Response.Write("<a href="""" onclick=""set_detail('" & .Item("BRAND_ID").ToString() & "')""><img src = '../RESOURCE/themes/images/set02/062-pencil.png' style='width:25px'  /> </a>")
                                            Response.Write("</td>")

                                            Response.Write("</tr>")
											%>
                                            <script>
												JOB_DATA.push(["<%response.Write(.Item("BRAND_ID").ToString)%>", "<%response.Write(.Item("BRAND_NAME").ToString)%>", "<%response.Write(.Item("BRAND_STATUS").ToString)%>"]);
                                            </script>
											<%
                                                        End With
                                                    Next
				...
				<div class="ui-block-d" style="width:35%;" >
					...
					<div class="ui-grid-solo ui-responsive">
						...
						<div class="ui-block-a" style="padding-left:10px; padding-right:10px">
							<label for="txt_name">แบรนด์:</label>
		...
		<%--<div data-role="footer" data-position="fixed" style="background-color:#f1f1f3!important;vertical-align:middle;color:darkslategrey;border:none;">		
			<div class="ui-grid-d center">
				...
				<div class="ui-block-d" style="font-size:0.7em;" >แบรนด์</div>
...
<script src="../JS/sys02.mng07.js"></script>
</html>
