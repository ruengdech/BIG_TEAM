...
<% 
    ...
    cls.strSql = "SELECT ORDERPROB_ID, ORDERPROB_NAME, ORDERPROB_STATUS FROM SYS02_MS_ORDER_PROB ORDER BY ORDERPROB_NAME"
	...
	<div data-role="page" id="page_main">
			...
			<div class="ui-grid-a ui-responsive">
				<div class="ui-block-a" style="width:65%;" >
                    ...
                    <table id="tb_list" class="table_list">
						<thead>
							<tr class="tr_main"><th style="width:50px">รหัส</th><th>ชื่อความเป็นไปได้</th><th> State </th><th> แก้ไข </th></tr>
                        </thead>
						<tbody>
							<% 
                                If cls.ds.Tables("JOB_DATA").Rows.Count > 0 Then
                                    For i As Integer = 0 To cls.ds.Tables("JOB_DATA").Rows.Count - 1
                                        With cls.ds.Tables("JOB_DATA").Rows(i)
                                            ...
                                            Response.Write("<td>")
                                            Response.Write(.Item("ORDERPROB_ID").ToString())
                                            Response.Write("</td>")

                                            Response.Write("<td>")
                                            Response.Write(.Item("ORDERPROB_NAME").ToString())
                                            Response.Write("</td>")

                                            Response.Write("<td>")
                                            Response.Write(.Item("ORDERPROB_STATUS").ToString())
                                            Response.Write("</td>")

                                            Response.Write("<td class='center'>")
                                            Response.Write("<a href="""" onclick=""set_detail('" & .Item("ORDERPROB_ID").ToString() & "')""><img src = '../RESOURCE/themes/images/set02/062-pencil.png' style='width:25px'  /> </a>")
                                            Response.Write("</td>")

                                            Response.Write("</tr>")
											%>
                                            <script>
												JOB_DATA.push(["<%response.Write(.Item("ORDERPROB_ID").ToString)%>", "<%response.Write(.Item("ORDERPROB_NAME").ToString)%>", "<%response.Write(.Item("ORDERPROB_STATUS").ToString)%>"]);
                                            </script>
											<%
                                                        End With
                                                    Next
		...
		<div data-role="footer" data-position="fixed" style="background-color:#f1f1f3!important;vertical-align:middle;color:darkslategrey;border:none;">		
			<div class="ui-grid-d center">
				...
				<div class="ui-block-a" style="min-height:50px;bottom:0;"><a href="mng01.aspx" rel="external"><img src="../RESOURCE/themes/images/set02/023-support.png" style="margin-top: 5px!important; width:35px;"  /></a></div>
				<div class="ui-block-b" style="min-height:50px;margin:auto;"><a href="mng02.aspx" rel="external"><img src="../RESOURCE/themes/images/set02/008-packaging.png" style="margin-top: 5px!important; width:35px; "/></a></div>
				<div class="ui-block-c" style="min-height:50px;margin:auto;"><a href="mng03.aspx" rel="external"><img src="../RESOURCE/themes/images/set02/004-strategy.png" style="margin-top: 5px!important; width:35px;" /></a></div>
				<div class="ui-block-d" style="min-height:50px;margin:auto;"><a href="mng04.aspx" rel="external"><img src="../RESOURCE/themes/images/set02/002-dollar.png" style="margin-top: 5px!important; width:35px;" /></a></div>
				<div class="ui-block-e" style="min-height:50px;margin:auto;"><a href="mng05.aspx" rel="external"><img src="../RESOURCE/themes/images/set02/025-hierarchy.png" style="margin-top: 5px!important; width:35px;" /></a></div>
...
<script src="../JS/sys02.mng03.js"></script>
</html>
