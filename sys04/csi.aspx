	...
	<div data-role="page" id="page_main">		
		<div data-role="header" style="background-color:#43bf79!important;border-color:#43bf79!important;text-shadow:none;">
			...
			<div style="min-height:50px;display:inline;">
				<img src="../img/SM_LOGO.gif" style="display:inline; vertical-align:middle; margin: 10px 10px 10px 20px; width:140px"/>
            </div>
			</center>
		</div><!-- /header -->
		...
		<div data-role="content" class="ui-content" data-theme="c">			
			<center>
				<h4>แบบสอบถามความพึงพอใจในคุณภาพการให้บริการ <br />แผนกบริการ บริษัท เซนต์เมด จำกัด (มหาชน)</h4>
			</center>
			<div class="ui-grid-solo ui-responsive">
                ...
                <div class="ui-grid-a" style="padding-left:10px; padding-right:10px">
						<input type="text" name="txt_ref1" id="txt_ref1" value="" style="display:none;" />
						<input type="text" name="txt_ref2" id="txt_ref2" value="" style="display:none;" />
                        <div class="ui-block-a">
...
<script src="../JS/sys04.csi.js"></script>
</html>
