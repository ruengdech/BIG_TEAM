...
Namespace SmartComm
    Public Class SmsClient
        ...
        Public Shared Function SendMssage(ByVal mobileNo As String, ByVal message As String, ByVal scheduleTime As DateTime?, ByVal category As String, ByVal senderName As String, <Out> ByRef statusMessage As String, <Out> ByRef taskId As String) As String 'Boolean
            statusMessage = ""
            taskId = ""
